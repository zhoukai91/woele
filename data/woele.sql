SET NAMES 'utf8';
DROP DATABASE IF EXISTS woele;
CREATE DATABASE woele CHARSET=UTF8;
USE woele;
...
INSERT INTO wel_dish(did,img_sm,img_lg,name,price,material,detail) VALUES
(   null,
    'p0281.jpg',
    'p0281-l.jpg',
    '【酸甜开胃虾】',
...
INSERT INTO wel_order(oid, phone,user_name,sex,order_time,addr,did) VALUES
(NULL,'15573294740','ZK',1,1479796800000,'湘潭大学琴湖10栋',3),
(NULL,'15573294740','ZK',1,1479816800000,'湘潭大学琴湖10栋',2),
(NULL,'15573294740','ZK',1,1479996800000,'湘潭大学琴湖10栋',5);
